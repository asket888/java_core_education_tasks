...
public class ChildFlower_7 extends Flower {
    ...
    public ChildFlower_7() throws Exception {
        ...
        setFlowerName(flowerFromXml.selectFlowerName(6));
        // Set flower price as a result of selectFlowerName() method with input parameter "6"
        setFlowerPrice(flowerFromXml.selectFlowerPrice(6));
    }
}
