...
import by.asket888.java.task4.jdbc.ooptask3copy.childflowers.*;
...
public class FlowersCollection {
    ...
    protected ArrayList<Flower> createAllFlowersCollection() throws ArrayStoreException, IOException, SQLException {
