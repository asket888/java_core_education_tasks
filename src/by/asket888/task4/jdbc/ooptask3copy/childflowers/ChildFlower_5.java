...
public class ChildFlower_5 extends Flower {
    ...
    public ChildFlower_5() throws IOException, SQLException {
        ...
        setFlowerName(flowerFromDb.selectFlowerName(5));
        // Set flower price as a result of selectFlowerPrice() method with input parameter "5"
        setFlowerPrice(flowerFromDb.selectFlowerPrice(5));
    }
}
